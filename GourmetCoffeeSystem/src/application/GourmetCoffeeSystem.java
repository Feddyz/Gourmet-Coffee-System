...
public class GourmetCoffeeSystem{
    ...
    private Catalog initCatalog() {
        ...
        catalog.addProduct(new Product("A003","Gourment Coffee Cookies",12.00));
        catalog.addProduct(new Product("A004","Gourmet Coffee Geramic Mug",8.00));
        catalog.addProduct(new Product("A005","Gourmet Coffee 36 Cup Filters",45.00));
    ...
    private void addCatalog() throws IOException {
        do {
            ...
            if (typeName == "a") {
                Product newCA = new Product(stdIn.readLine(),stdIn.readLine(),Double.parseDouble(stdIn.readLine()));
